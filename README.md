...
```jsonc
{
  ...
  // recall request timeout in ms for auto-recall and the hindsight_recall tool (default: 10000);
  // increase if recall regularly times out on large memory banks or in VMs with constrained resources
